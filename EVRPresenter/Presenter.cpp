...
HRESULT EVRCustomPresenter::DetachObject()
{
	return E_NOTIMPL;
}

HRESULT EVRCustomPresenter::ShutdownObject()
{
	HRESULT hr = S_OK;
	Release();
	return hr;
...
HRESULT EVRCustomPresenter::GetUnknown(REFGUID guidKey, REFIID riid, LPVOID *ppv)
{
	assert(m_pAttributes);
    return m_pAttributes->GetUnknown(guidKey, riid, ppv);
}

HRESULT EVRCustomPresenter::SetUnknown(REFGUID guidKey, IUnknown *pUnknown)
{
	assert(m_pAttributes);
    return m_pAttributes->SetUnknown(guidKey, pUnknown);
}

HRESULT EVRCustomPresenter::GetSizeMax(ULARGE_INTEGER *pcbSize)
{
	return E_NOTIMPL;
	HRESULT hr = S_OK;
...
HRESULT EVRCustomPresenter::IsDirty()
{
	return E_NOTIMPL;
	HRESULT hr = S_OK;
...
HRESULT EVRCustomPresenter::Load(IStream *pStm)
{
	return E_NOTIMPL;
	HRESULT hr = S_OK;
...
HRESULT EVRCustomPresenter::Save(IStream *pStm, BOOL fClearDirty)
{
	return E_NOTIMPL;
	HRESULT hr = S_OK;
...
HRESULT EVRCustomPresenter::GetClassID(CLSID *pClassID)
{
	/*if(!pClassID)
        return E_POINTER;

    *pClassID = CLSID_CustomEVRPresenter;
