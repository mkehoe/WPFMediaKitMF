...
namespace WPFMediaKit.DirectShow
{
    ...
    public class EvrPresenter : ICustomAllocator, IEVRPresenterCallback
    {
        ...
        /// </summary>
        public MediaFoundation.EVR.IMFVideoPresenter VideoPresenter { get; private set; }
        ...
        public static EvrPresenter CreateNew()
        {
            ...
            Guid guidVideoPresenter = typeof(MediaFoundation.EVR.IMFVideoPresenter).GUID;
            ...
            var presenter = comObject as MediaFoundation.EVR.IMFVideoPresenter;
