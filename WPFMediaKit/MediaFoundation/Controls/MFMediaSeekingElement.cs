...
namespace MediaFoundation.Controls
{
    ...
    /// </summary>
    public abstract class MFMediaSeekingElement : MFMediaElementBase
    {
        /// <summary>
        ...
        public static readonly DependencyProperty MediaPositionProperty =
            DependencyProperty.Register("MediaPosition", typeof(long), typeof(MFMediaSeekingElement),
        ...
        {
            ((MFMediaSeekingElement)d).OnMediaPositionChanged(e);
        }
        ...
        private void PlayerSetMediaPosition()
        {
            ...
            if (MFMediaPlayerBase.Dispatcher.Shutdown || MFMediaPlayerBase.Dispatcher.ShuttingDown)
                return;
            MFMediaPlayerBase.Dispatcher.BeginInvoke((Action)
                                                  (() => MFMediaSeekingPlayer.MediaPosition = position));
        }
        ...
        private static readonly DependencyPropertyKey MediaDurationPropertyKey
           = DependencyProperty.RegisterReadOnly("MediaDuration", typeof(long), typeof(MFMediaSeekingElement),
                                                 new FrameworkPropertyMetadata((long)0));
        ...
        private static readonly DependencyPropertyKey CurrentPositionFormatPropertyKey
            = DependencyProperty.RegisterReadOnly("CurrentPositionFormat", typeof(MediaPositionFormat), typeof(MFMediaSeekingElement),
        ...
        public static readonly DependencyProperty PreferedPositionFormatProperty =
            DependencyProperty.Register("PreferedPositionFormat", typeof(MediaPositionFormat), typeof(MFMediaSeekingElement),
        ...
        {
            ((MFMediaSeekingElement)d).OnPreferedPositionFormatChanged(e);
        }
        ...
        private void PlayerSetPreferedPositionFormat()
        {
            ...
            MFMediaSeekingPlayer.Dispatcher.BeginInvoke((Action)delegate
            {
                MFMediaSeekingPlayer.PreferedPositionFormat = format;
                currentFormat = MFMediaSeekingPlayer.CurrentPositionFormat;
                duration = MFMediaSeekingPlayer.Duration;
        ...
        public static readonly DependencyProperty SpeedRatioProperty =
            DependencyProperty.Register("SpeedRatio", typeof(double), typeof(MFMediaSeekingElement),
        ...
        {
            ((MFMediaSeekingElement)d).OnSpeedRatioChanged(e);
        }
        ...
        private void PlayerSetSpeedRatio()
        {
            ...
            MFMediaSeekingPlayer.Dispatcher.BeginInvoke((Action)delegate
            {
                MFMediaSeekingPlayer.SpeedRatio = speedRatio;
            });
        }
        #endregion
        ...
        /// </summary>
        protected MFMediaSeekingPlayer MFMediaSeekingPlayer
        {
            get { return MFMediaPlayerBase as MFMediaSeekingPlayer; }
        }
        ...
        protected override void InitializeMediaPlayer()
        {
            ...
            if (MFMediaSeekingPlayer == null)
                throw new Exception("MFMediaSeekingPlayer is null or does not inherit MFMediaSeekingPlayer");

            /* Let us know when the media position has changed */
            MFMediaSeekingPlayer.MediaPositionChanged += OnMediaPlayerPositionChangedPrivate;
        }
        ...
        {
            long position = MFMediaSeekingPlayer.MediaPosition;
            long duration = MFMediaSeekingPlayer.Duration;
        ...
        protected override void OnMediaPlayerOpened()
        {
            ...
            var positionFormat = MFMediaSeekingPlayer.CurrentPositionFormat;
            ...
            Dispatcher.BeginInvoke((Action)delegate
            {
                ...
                MFMediaSeekingPlayer.Dispatcher.BeginInvoke((Action)delegate
                {
                    ...
                    MFMediaSeekingPlayer.SpeedRatio = rate;
